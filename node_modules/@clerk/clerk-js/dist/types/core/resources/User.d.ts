import type { BackupCodeResource, CreateEmailAddressParams, CreateExternalAccountParams, CreatePhoneNumberParams, CreateWeb3WalletParams, DeletedObjectResource, EmailAddressResource, EnterpriseAccountResource, EnterpriseConnectionResource, ExternalAccountResource, GetEnterpriseConnectionsParams, GetOrganizationMemberships, GetUserOrganizationInvitationsParams, GetUserOrganizationSuggestionsParams, ImageResource, OrganizationMembershipResource, PasskeyResource, PhoneNumberResource, RemoveUserPasswordParams, SetProfileImageParams, TOTPResource, UpdateUserParams, UpdateUserPasswordParams, UserJSON, UserJSONSnapshot, UserResource, VerifyTOTPParams, Web3WalletResource } from '@clerk/shared/types';
...
export declare class User extends BaseResource implements UserResource {
    ...
    getOrganizationInvitations: (params?: GetUserOrganizationInvitationsParams) => Promise<import("@clerk/shared/types").ClerkPaginatedResponse<UserOrganizationInvitation>>;
    getOrganizationSuggestions: (params?: GetUserOrganizationSuggestionsParams) => Promise<import("@clerk/shared/types").ClerkPaginatedResponse<OrganizationSuggestion>>;
    getOrganizationMemberships: GetOrganizationMemberships;
    getOrganizationCreationDefaults: () => Promise<import("@clerk/shared/types").OrganizationCreationDefaultsResource>;
